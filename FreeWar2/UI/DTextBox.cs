...
namespace DGui
{
    ...
    public class DTextBox : DTextBoxBase
    {
        ...
        Rectangle _selectionBoxRectangle;
                    ...
                    if (closestLetterIndex != -1 && closestLetterIndex != CursorIndex)
                    {
                        if (!_allSelected)
                        {
                            ...
                            if (closestLetterIndex != SelectionIndex || !Selection)
                            {
                                ...
                                {
                                    SetSelectionRectangle(new Rectangle((int)dragLocation.X, (int)dragLocation.Y,
                                        (int)_selectionPosition.X - (int)dragLocation.X,
                                        Cursor.Height));
                                }
                                else
                                {
                                    SetSelectionRectangle(new Rectangle((int)_selectionPosition.X, (int)dragLocation.Y,
        ...
        public override void SelectAll()
        {
            ...
            if (Text.Length > 0)
            {
                ...
                SetSelectionRectangle(new Rectangle((int)CursorPosition.X, (int)CursorPosition.Y, (int)_selectionPosition.X - (int)CursorPosition.X, Cursor.Height));
            }
        }
        ...
        private void SetSelectionRectangle(Rectangle rectangle)
        {
