        ...
        protected override void DrawWithClipRect()
        {
            if (Visible)
            {
                ...
                if (SourceRectangle.HasValue && IsPartiallyObscured)
                {
                    ...
                    //Game.GraphicsDevice.Clear(ClearOptions.Target | ClearOptions.DepthBuffer, Color.Transparent, 1, 0);
                    ...
                    _texture = renderTarget; //renderTarget.GetData<Texture2D>(_texture); //GetTexture();
                ...
                else if (Parent == null || !Parent.IsTotallyObscured)
                {
                    //draw the text!
