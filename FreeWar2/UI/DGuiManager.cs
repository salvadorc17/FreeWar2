...
namespace DGui
{
    ...
    public class DGuiManager : DrawableGameComponent
    {
        ...
        SceneNode _controlsSceneNode;
        SceneNode _controlTextSceneNode;
        SceneNode _foregroundSceneNode;
        SceneNode _foregroundTextSceneNode;
        ...
        public SceneNode ControlsSceneNode
        {
            get { return _controlsSceneNode; }
            set { _controlsSceneNode = value; }
        }
        public SceneNode ForegroundSceneNode
        {
        ...
        {
            _game = game;
            _sceneGraph = new SceneGraph(game);
            _controlsSceneNode = new SceneNode(game);
            _foregroundSceneNode = new SceneNode(game);
            _controlTextSceneNode = new SceneNode(game);
            _foregroundTextSceneNode = new SceneNode(game);
        ...
        public override void Draw(GameTime gameTime)
        {
            if (_sceneGraph != null)
            {
                ...
                //_game.GraphicsDevice.DepthStencilState.DepthBufferEnable = true;
                //_game.GraphicsDevice.BlendState.AlphaSourceBlend = Blend.Zero;
                //_game.GraphicsDevice.BlendState.AlphaDestinationBlend = Blend.Zero;
        ...
        public void RemoveControl(DPanel panel)
        {
            if (_sceneGraph != null)
            {
                _controlsSceneNode.Children.Remove(panel);
            }
        }
