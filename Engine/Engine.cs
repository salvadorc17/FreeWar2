...
namespace DEngine
{
    ...
    public class Engine : Microsoft.Xna.Framework.Game
    {
        ...
        protected int _tileHeight = 64;
        protected int _tileWidth = 64;
        protected System.Drawing.Size _screenSize = new System.Drawing.Size(1280,960);
        ...
        public Engine()
        {
            ...
            try
            {
                ...
                _screenSize.Width = Convert.ToInt32(_appSettingsReader.GetValue("ScreenWidth", typeof(String)));
                _screenSize.Height = Convert.ToInt32(_appSettingsReader.GetValue("ScreenHeight", typeof(String)));
            ...
            this._graphics.PreferredBackBufferWidth = _screenSize.Width;
            this._graphics.PreferredBackBufferHeight = _screenSize.Height;
            ...
            _sceneGraph.CullingDistance = _screenSize.Width;
        }
        #endregion
        ...
        public void RunLevel(Level level)
        {
            ...
            _currentLevel = level;
            _tileGrid = new Tile[_currentLevel.Width, _currentLevel.Height];
