...
namespace DGui
{
    ...
    public class DTextBox : DTextBoxBase
    {
        ...
        Microsoft.Xna.Framework.Rectangle _selectionBoxRectangle;
        ...
        protected override void LoadContent()
        {
            ...
            _selectionBox = new Texture2D(Game.GraphicsDevice, 1, 1);
                    ...
                    if (closestLetterIndex != -1 && closestLetterIndex != CursorIndex)
                    {
                        if (!_allSelected)
                        {
                            ...
                            if (closestLetterIndex != SelectionIndex || !Selection)
                            {
                                ...
                                {
                                    SetSelectionRectangle(new Microsoft.Xna.Framework.Rectangle((int)dragLocation.X, (int)dragLocation.Y,
                                        (int)_selectionPosition.X - (int)dragLocation.X,
                                        Cursor.Height));
                                }
                                else
                                {
                                    SetSelectionRectangle(new Microsoft.Xna.Framework.Rectangle((int)_selectionPosition.X, (int)dragLocation.Y,
                                        (int)dragLocation.X - (int)_selectionPosition.X,
                                        Cursor.Height));
                                }
                            }
                            else
        ...
        public override void SelectAll()
        {
            ...
            if (Text.Length > 0)
            {
                ...
                SetSelectionRectangle(new Microsoft.Xna.Framework.Rectangle((int)CursorPosition.X, (int)CursorPosition.Y, (int)_selectionPosition.X - (int)CursorPosition.X, (int)Cursor.Height));
            }
        }
        ...
        private void SetSelectionRectangle(Microsoft.Xna.Framework.Rectangle rectangle)
        {
            if (rectangle.Width >= 1 && rectangle.Height >= 1)
            {
                _selectionBox = new Texture2D(Game.GraphicsDevice, (int)(rectangle.Width), (int)rectangle.Height);
            ...
            if (IsFocused)
            {
                if (Selection)
                {
                    _guiManager.SpriteBatch.Draw(_selectionBox,
                        ...
                        null, Color.Gray, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0);
                }
            }
        }
    }
