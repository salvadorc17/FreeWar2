...
namespace DGui.DrawingSystem {
    public class DrawingHelper {
        ...
        public static Texture2D CreateLineTexture(GraphicsDevice graphicsDevice, int width, int height, Color color)
        {
        ...
        public static Texture2D CreateLineTexture(GraphicsDevice graphicsDevice, int lineThickness, Color color) {
            Texture2D texture2D = new Texture2D(graphicsDevice, 2, lineThickness + 2);
            ...
            colorArray[count - 2] = Color.Transparent;
            colorArray[count - 1] = Color.Transparent;
            texture2D.SetData<Color>(colorArray);
            return texture2D;
        }
